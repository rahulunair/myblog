...
pagetitle: "QLoRA Text-to-SQL on Intel GPUs"
description: "Fine-tune large language models for text-to-SQL with QLoRA on Intel GPUs, then compare base and adapted model inference using reusable LoRA adapters."
date: "2023-12-05"
categories: [intel, dgpu, pvc1100, arc, pytorch, bigdl-llm]
image: /assets/site-card.png
image-alt: "Technical ramblings: Intel GPUs, kernels, model serving, Rust, and machine learning."
---
...
<figure align="center">
  <img src="./images/launghing_llama.jpg" width="800" alt="Illustration of a smiling llama wearing sunglasses on a tropical beach">
   <figcaption style="font-size: 0.8em; margin-top: 5px; max-width: 800px; text-align: center;">Generated with Stable Diffusion XL using the prompt: "A cute laughing llama with big eye lashes, sitting on a beach with sunglasses reading in gibili style."</figcaption>
 </figure>
...
<figure align="center">
  <img src="./images/lora_library.png" width="800" alt="Two-part diagram showing frozen model weights with trainable low-rank A and B adapters, then a frozen foundation model selecting among task-specific LoRA adapters">
   <figcaption style="font-size: 0.8em; margin-top: 5px; max-width: 800px; text-align: center;">Left: Integration of LoRA adapters into the model. Right: Deployment of LoRA adapters with a foundation model as a task-specific model library
  </figcaption>
</figure>
...
<figure align="center">
  <img src="./images/loss_chart.jpg" width="800" alt="Training and evaluation loss fall from above 2.2 to about 0.7 over 320 fine-tuning steps">
   <figcaption style="font-size: 0.8em; margin-top: 5px; max-width: 800px; text-align: center;">Training and Validation loss during fine-tuning a CodeLlama-7b model on the b-mc2/sql-create-context dataset.</figcaption>
</figure>
...
<figure align="center">
  <img src="./images/finetuned.png" width="800" alt="Fine-tuned model correctly generates a COUNT query for John Smith's goals last season">
   <figcaption style="font-size: 0.8em; margin-top: 5px; max-width: 800px; text-align: center;">Fine-tuned model SQL generation for a given question and context.</figcaption>
</figure>

Base Model:

<figure align="center">
  <img src="./images/base_model.png" width="800" alt="Base model incorrectly generates a SUM query and continues with unrelated text">
   <figcaption style="font-size: 0.8em; margin-top: 5px; max-width: 800px; text-align: center;">Base model SQL generation for a given question and context.</figcaption>
</figure>
...
<figure align="center">
  <img src="./images/idc_page.webp" width="800" alt="Intel Developer Cloud Gen AI Essentials catalog showing six notebooks, including LLM fine-tuning with QLoRA">
   <figcaption style="font-size: 0.8em; margin-top: 5px; max-width: 800px; text-align: center;">LLM Fine-tuning and other notebooks in Gen AI Essentials under the Training Catalog on IDC.</figcaption>
</figure>
