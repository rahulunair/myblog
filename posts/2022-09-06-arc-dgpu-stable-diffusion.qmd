...
pagetitle: "Stable Diffusion on Intel Arc GPUs"
description: "Run Stable Diffusion on Intel Arc GPUs under Linux with both PyTorch and TensorFlow, including Arc setup, package installation, and sample inference."
date: "2022-11-06"
date-published: "2022-11-06"
categories: [intel, dgpu, graphics, arc, pytorch, tensorflow]
...
![Stable Diffusion output from PyTorch FP16](./images/sd_pyt_fp16.png){fig-alt="Stable Diffusion PyTorch FP16 output showing red heart-shaped hot-air balloons over Paris and the Eiffel Tower"}
...
![Stable Diffusion output from TensorFlow FP32](./images/sd_tf_fp32.png){fig-alt="Stable Diffusion TensorFlow FP32 output showing red hot-air balloons above Parisian buildings at sunset"}
...
You can find the full code and other related materials [here](https://github.com/rahulunair/stable_diffusion_arc).
