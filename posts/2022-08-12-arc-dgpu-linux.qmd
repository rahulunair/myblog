---
toc: true
description: Configure Linux to utilize Intel Arc A370M Xe-HPG discrete GPU
...
Checkout the `pytorch` [directory](https://github.com/rahulunair/intel_arc_dgpu_linux/tree/main/pytorch) to know how to install PyTorch and IPEX with dGPU support.
