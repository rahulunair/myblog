...
pagetitle: "Intel Arc A370M Setup on Linux"
description: "A step-by-step Ubuntu 22.04 setup for Intel Arc A370M graphics on Linux, including the kernel, Mesa, oneAPI, SYCL discovery, and GPU monitoring."
date: "2022-10-12"
...
![Ubuntu Mainline Kernel Installer](https://user-images.githubusercontent.com/45503355/195398959-c28fe9f3-47c9-46cd-b1a0-5e26d8e6228a.png){fig-alt="Ubuntu Mainline Kernel Installer showing Linux 6.0.0 with status Running"}
...
![glmark2 running on an Intel Arc A370M GPU](assets/arc370m_bench.gif){fig-alt="Terminal running glmark2 on an Intel Arc A370M GPU, with the benchmark window displaying a rotating textured cube"}
...
![sysmon output on my laptop](https://user-images.githubusercontent.com/45503355/195416715-923dc33a-acbd-411e-a774-7a38c13e72f3.png){fig-alt="sysmon terminal output listing the Intel Arc A370M discrete GPU and integrated Intel graphics device details"}
